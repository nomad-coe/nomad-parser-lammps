...
def test_nvt(parser):
    ...
    assert sec_scc[56].thermodynamics.pressure.magnitude == approx(-77642135.4975)
    assert sec_scc[103].thermodynamics.temperature.magnitude == 291.4591
    assert sec_scc[11].thermodynamics.time_step == 4400
